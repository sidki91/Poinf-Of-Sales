...
<p></p>
						<div class="form">
						  <div class="form-group">
						   <div class="col-md-10">
              <input type="text" class="form-control" id="warehouse_search" placeholder="Enter UOM" onkeypress="search_enter(event)">
						  </div>
            </div>
    ...
    else
    {
      ...
      $.ajax({
          ...
          success: function(data)
          {
            ...
            {
                if (data.errors.wh_name)
                {
                      alertMsg(data.errors.wh_name,'error');
                }
