...
<div class="form">
    <div class="form-group">
        <div class="col-md-10">
            <input type="text" class="form-control" id="section_search" placeholder="Enter Section" onkeypress="search_enter(event)">
        </div>
    </div>
...
<div id="addModal" class="modal fade" role="dialog">
    ...
    <script type="text/javascript">
        ...
        function list_data() {
            var page          = 1;
            var pagination    = '';
            var section       = $("#section_search").val();
            $.ajax({
                type: "POST",
                url: 'section/list_data',
                data: {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 'error')
                    {
                        ...
                        {
                            alertMsg(data.errors.section, 'error');
                        }
