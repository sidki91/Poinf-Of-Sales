...
<div class="form">
    <div class="form-group">
        <div class="col-md-10">
            <input type="text" class="form-control" id="division_search" placeholder="Enter Division" onkeypress="search_enter(event)">
        </div>
    </div>
...
<div id="addModal" class="modal fade" role="dialog">
    ...
    <script type="text/javascript">
        ...
        function list_data() {
            var page          = 1;
            var pagination    = '';
            var division      = $("#division_search").val();
            $.ajax({
                type: "POST",
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 'error')
                    {
                        ...
                        {
                            alertMsg(data.errors.division, 'error');
                        }
