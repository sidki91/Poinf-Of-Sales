...
<div class="form">
    <div class="form-group">
        <div class="col-md-10">
            <input type="text" class="form-control" id="percentage_search" placeholder="Enter Percentage" onkeypress="search_enter(event)">
        </div>
    </div>
...
<div id="addModal" class="modal fade" role="dialog">
    ...
    <script type="text/javascript">
        ...
        function list_data() {
            var page          = 1;
            var pagination    = '';
            var percentage    = $("#percentage_search").val();
            $.ajax({
                type: "POST",
                url: 'percentage/list_data',
                data: {
