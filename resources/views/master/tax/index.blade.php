...
<div class="form">
    <div class="form-group">
        <div class="col-md-10">
            <input type="text" class="form-control" id="tax_search" placeholder="Enter Tax Name" onkeypress="search_enter(event)">
        </div>
    </div>
                ...
                <div id="HTMLcontent">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="tax_value">
                                <!-- <p class="help-block">Example block-level help text here.</p> -->
                            </div>
                        </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 'error')
                    {
                        ...
                        {
                            alertMsg(data.errors.tax_name, 'error');
                        }
                        if (data.errors.tax_value)
                        {
                            alertMsg(data.errors.tax_value, 'error');
                        }
