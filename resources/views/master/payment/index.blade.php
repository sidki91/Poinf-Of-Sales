...
<div class="form">
    <div class="form-group">
        <div class="col-md-10">
            <input type="text" class="form-control" id="payment_search" placeholder="Enter Payment" onkeypress="search_enter(event)">
        </div>
    </div>
...
<div id="addModal" class="modal fade" role="dialog">
    ...
    <script type="text/javascript">
        ...
        function list_data() {
            var page       = 1;
            var pagination = '';
            var payment    = $("#payment_search").val();
            $.ajax({
                type: "POST",
                url: 'payment/list_data',
                data: {
