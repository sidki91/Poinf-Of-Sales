...
<div class="form">
    <div class="form-group">
        <div class="col-md-10">
            <input type="text" class="form-control" id="cust_class_search" placeholder="Enter Customer Class" onkeypress="search_enter(event)">
        </div>
    </div>
...
<div id="addModal" class="modal fade" role="dialog">
                ...
                <div id="HTMLcontent">
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="customer_class">
    ...
    <script type="text/javascript">
        ...
        function list_data() {
            var page            = 1;
            var pagination      = '';
            var customer_class  = $("#cust_class_search").val();
            $.ajax({
                type: "POST",
                url: 'custClass/list_data',
                data: {
