<div class="topbar">
  <div class="topbar-left">
      <div class="logo">
          <h1><a href="#"><img src="{{ URL::asset('public/assets/img/logo.png')}}" alt="Logo"></a></h1>
      </div>
        ...
        <div class="navbar-collapse2">
            ...
            <ul class="nav navbar-nav navbar-right top-navbar">
                ...
                <li class="dropdown topbar-profile">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="rounded-image topbar-profile-image"><img src="{{ URL::asset('public/assets/images/users/icons8-user-40.png')}}" ></span> {{ Auth::user()->name }} <i class="fa fa-caret-down"></i></a>
