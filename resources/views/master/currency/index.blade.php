...
<p></p>
						<div class="form">
						  <div class="form-group">
						   <div class="col-md-10">
              <input type="text" class="form-control" id="currency_search" placeholder="Enter Currency" onkeypress="search_enter(event)">
						  </div>
            </div>
...
function list_data()
{
   var page       = 1;
   var pagination = '';
   var currency   = $("#currency_search").val();
  $.ajax({
          type: "POST",
           url: 'currency/list_data',
           data: {
    ...
    else
    {
      ...
      $.ajax({
          ...
          success: function(data) {
            ...
            {
                if (data.errors.currency_name)
                {
                      alertMsg(data.errors.currency_name,'error');
                }
