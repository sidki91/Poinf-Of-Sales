...
@section('class_organization','active subdrop')
@section('class_ul_organization','display: block')
@section('m_counter','active')
@section('firstmenu','Master Data')
@section('menu','Organization Group')
@section('sub_menu','Counter')
...
<div class="form">
    <div class="form-group">
        <div class="col-md-10">
            <input type="text" class="form-control" id="counter_search" placeholder="Enter Counter" onkeypress="search_enter(event)">
        </div>
    </div>
...
<div id="addModal" class="modal fade" role="dialog">
    ...
    <script type="text/javascript">
        ...
        function list_data() {
            var page          = 1;
            var pagination    = '';
            var counter       = $("#counter_search").val();
            $.ajax({
                type: "POST",
                url: 'counter/list_data',
                data: {
        ...
        $('.modal-footer').on('click', '.add', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    {
                        if (data.errors.counter)
                        {
                            alertMsg(data.errors.counter, 'error');
                        }
