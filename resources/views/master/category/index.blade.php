...
@section('m_category','active')
@section('firstmenu','Master Data')
@section('menu','Material Group')
@section('sub_menu','Product Category')
...
<p></p>
						<div class="form">
						  <div class="form-group">
						   <div class="col-md-10">
              <input type="text" class="form-control" id="description_search" placeholder="Enter Category" onkeypress="search_enter(event)">
						  </div>
            </div>
